...
#define MAX_DATABASE_SIZE \
    5000000  // The maximum allowed disk size of the primary database file at open, in bytes
#define VACUUM_THRESHOLD \
    0.8  // The database is vacuumed after its size exceeds this proportion of the maximum.

@interface SMTopazAnalyticsDatabase : NSObject {
...
- (BOOL)addHeaderWithSequenceNumber:(int)number
                         blobString:(NSString *)blob
                              rowId:(sqlite3_int64 *)insertedRowId;
